...
[![CI](https://github.com/epfff/agent-vibes/actions/workflows/ci.yml/badge.svg?branch=dev)](https://github.com/epfff/agent-vibes/actions/workflows/ci.yml)
...
若未经定制修改，你可以直接从 [GitHub Releases](https://github.com/epfff/cursor-proxy/releases) 一键下载并安装：
...
## 交流讨论
欢迎在 [LINUX DO](https://linux.do/t/topic/1814066) 参与关于 Cursor Proxy 的讨论与交流，或者随时在 [GitHub Issues](https://github.com/epfff/cursor-proxy/issues) 反馈问题。

## 贡献
如果你发现了 bug，或者有新的想法，欢迎使用我们的 [issue templates](https://github.com/epfff/cursor-proxy/issues/new/choose) 提交 bug 或功能请求。
